            ...
            <div class="bg-light px-2 py-4" style="box-shadow: 0 0px 11px rgb(72 79 99 / 30%);">
                <form action="{{ route('admin.clients.filter1') }}" method="GET">
                    <div class="p-1">
                        ...
                        <div class="mb-4">
                            <h5 class="d-inline mr-auto">CampaignID</h5>
                            <div class="d-block">
                    ...
                    <div class="px-2">
                        <div class="d-flex">
                            <div class="ml-auto mr-0">
                                <a class="btn btn-primary mb-3" data-toggle="modal" data-target="#import_csv"><i class="fa fa-upload"></i>&nbsp;&nbsp; Import</a>
                                <a class="btn btn-primary mb-3" href="{{ route('admin.clients.create') }}"><i class="fa fa-plus"></i>&nbsp;&nbsp; Add Client</a>
                            </div>
                        </div>
...
<form action="{{ route('admin.clients.sortid') }}" method="GET" id="sortById">
    ...
    <input type="hidden" value="" name="campaigns">
</form>
...
<form action="{{ route('admin.clients.lastby') }}" method="" id="sortLastTouch">
                ...
                <form action="{{ route('admin.database.upload') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <div class="input-field">
                            <p class="">Choose CSV File:</p> 
                            <input class="ml-4" type="file" name="upload_csv" id="file" accept=".csv">
                        </div>
                    </div>
