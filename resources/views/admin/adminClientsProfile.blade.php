        ...
        <div class="col-sm-4">
            <div class="bg-light px-4 py-4" style="box-shadow: 0 0px 11px rgb(72 79 99 / 30%);">
                ...
                <div class="radius-border pt-2 px-1">
                    ...
                    <div>
                        <label for="fname" class="my-2 label-style right-border">Address 1:</label>
                        <p class="d-inline ml-3">{{$info->address1}}</p>
                    </div>
                    <div>
                        <label for="fname" class="my-2 label-style right-border">Address 2:</label>
                    ...
                    <div>
                        ...
                        @foreach ($campaigns as $campaign)
                            @if (in_array($campaign->id, $selected_campaigns))
                                <p class="d-inline ml-3">{{ $campaign->campaign_name }}</p>
                            @endif
                        @endforeach
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.clients.information.edit') }}">
                        <div class="form-group">
                            <div class="" style="margin:auto;width:75%">
                                ...
                                <div>
                                    <label for="fname" class="my-2 label-style">Address 1:</label>
                                    <input type="text" id="address1" name="address1" class="mb-1 full-width-style " value= "{{$info->address1}}" >
                                </div>
                                <div>
                                    <label for="fname" class="my-2 label-style">Address 2:</label>
                                    <input type="text" id="address2" name="address2" class="mb-1 full-width-style " value= "{{$info->address2}}" >
                                </div>
                                <div>
    ...
    <div class="modal fade" id="bio">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <!-- Modal body -->
                <div class="modal-body">
                    <form action="{{ route('admin.clients.notes.edit') }}">
                        <div class="form-group ">
    ...
    <div class="modal fade" id="income">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <!-- Modal body -->
                <div class="modal-body">
                    <form action="{{ route('admin.clients.income.edit') }}">
                        <div class="form-group ">
    ...
    <div class="modal fade" id="deduction">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <!-- Modal body -->
                <div class="modal-body">
                    <form action="{{ route('admin.clients.deduction.edit') }}">
                        <div class="form-group ">
                            <div class="input-field">
                                <div class="d-block">
