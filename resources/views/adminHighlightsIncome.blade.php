...
<div class="container">
    <div class="subtitle">
        <div class="d-flex ">
            <span class="bg-light px-4 py-2 border-shadow"><h5 class="d-inline">Setting</h5><h5 class="d-inline"> / </h5><h5 class="d-inline">Highlights</h5><h5 class="d-inline"> / </h5><h5 class="d-inline">Income</h5></span>
        </div>
    </div>
    <div class="my-3"></div>
