        ...
        <table class="table">
            ...
            @foreach ($users as $user)
                <tr>
                    ...
                    <td><a class="user-edit-icon" data-name="{{$user->name}}" data-email="{{$user->email}}"  data-roll="{{$user->roll}}" data-id="{{$user->id}}"> <i class='fas fa-pencil-alt mr-2' style='font-size:16px' data-toggle="modal" data-target="#edit"></i></a><a class="delete-icon" data-id="{{$user->id}}"><i class="fa fa-trash ml-2" aria-hidden="true" data-toggle="modal" data-target="#delete"></i></a></td>
                </tr>
            @endforeach
            </tbody>
        </table>
