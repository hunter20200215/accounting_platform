        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('bookkeeper.information.edit') }}" method="POST">
                        @csrf
    ...
    <div class="modal fade" id="bio">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <!-- Modal body -->
                <div class="modal-body">
                    <form action="{{ route('bookkeeper.bio.edit') }}" method="POST">
                        @csrf
                        <div class="form-group ">
    ...
    <div class="modal fade" id="add_info">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <!-- Modal body -->
                <div class="modal-body">
                    <form action="{{ route('bookkeeper.add.edit') }}" method="POST">
                        @csrf
                        <div class="form-group ">
                            <div class="input-field">
