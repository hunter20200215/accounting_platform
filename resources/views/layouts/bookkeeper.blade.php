...
<div id="app" class="">
    <nav class="navbar navbar-expand-md navbar-light shadow-sm" style="background-color:#fff;">
        <div class="container">
            ...
            <a class="navbar-brand" href="{{ route('bookkeeper.home') }}" style="font-size: 1.5rem;letter-spacing: 2px;">
            ...
            <div class="collapse navbar-collapse ml-5" id="navbarSupportedContent" style="font-size:16px;color:black;">
                ...
                <ul class="navbar-nav mr-auto">
                    @auth
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('bookkeeper.home') }}">{{ __('Home') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('bookkeeper.clients') }}">{{ __('Clients') }}</a>
                        </li>
                    @endauth
                </ul>
                    ...
                    @else
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                <a class="dropdown-item" href="{{ route('bookkeeper.highlights') }}">Highlights</a>
                            </div>
                        </li>
