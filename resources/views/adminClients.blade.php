                    ...
                    <div class="px-2">
                        ...
                        <div class="d-flex"> 
                            ...
                            <div class="input-group ml-auto mr-0" style="width:65%;">
                                <input type="text" class="form-control" placeholder="Please input search query" name="full_name">
                                <div class="input-group-append">
                                    <a class=" btn-secondary" data-toggle="modal" data-target="#edit_filter">
