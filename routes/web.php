...
Route::post('entry/sort-by-aame', [App\Http\Controllers\EntryController::class, 'entrySortByName'])->name('entry.clients.sortname')->middleware('is_entry');
Route::post('entry/sort-by-phone', [App\Http\Controllers\EntryController::class, 'entrySortByPhone'])->name('entry.clients.sortphone')->middleware('is_entry');
Route::post('entry/sort-by-createBy', [App\Http\Controllers\EntryController::class, 'entrySortByCreatedBy'])->name('entry.clients.createdby')->middleware('is_entry');
Route::post('entry/sort-by-data-added', [App\Http\Controllers\EntryController::class, 'entrySortByDataAdded'])->name('entry.clients.dataadded')->middleware('is_entry');
Route::post('entry/sort-by-last-touch', [App\Http\Controllers\EntryController::class, 'entrySortByLastTouch'])->name('entry.clients.lastby')->middleware('is_entry');
